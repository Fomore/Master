...
Camera::Camera(int id)
{
    ...
    //Innenaufnahme
    mRotMatrix = cv::Matx33d(0.9936250804552885, 0.02728012937864771, -0.1093846151490516,
                             -0.06191789343416376, 0.9428916061749613, -0.3272943529569031,
                             0.09420920317515354, 0.3319807427334997, 0.9385698761899492);
    mTranslation = cv::Vec3d(0, 206, 31);
    //fx=1020.5 fy=1060.48

    // Außenaufnahme
    mRotMatrix = cv::Matx33d(0.9991210426367227, 0.01819698638228107, -0.03776257204045606,
                             -0.02514705216574931, 0.9809467424500694, -0.1926424518219437,
                             0.03353755995716829, 0.1934227446894493, 0.980542132653625);
    mTranslation = cv::Vec3d(0, 148+40, 0);
    //fx=1067.82 fy=937.186
