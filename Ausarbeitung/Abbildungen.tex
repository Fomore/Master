...
\begin{figure}
	...
	\caption{Zusammenhang zwischen der Skalierung und der Abweichung des Winkels in X-Richtung, Angabe in Grad.\\
		Von rechts nach links: Bicubic, Lanczos, Linear, Nearest-Neighbor}
...
\begin{figure}
	...
	\caption{Zusammenhang zwischen der Skalierung (X-Achse) und der Abweichung des Winkels in X-Richtung, Angabe in Grad.\\
		Von rechts nach links: Bicubic, Lanczos, Linear, Nearest-Neighbor}
...
\begin{figure}
	...
	\caption{Zusammenhang zwischen der Skalierung (X-Achse) und der Abweichung des Winkels in Y-Richtung, Angabe in Grad.\\
		Von rechts nach links: Bicubic, Lanczos, Linear, Nearest-Neighbor}
